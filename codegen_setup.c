...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Tomba2",
    .project_root_env = "TOMBA2RECOMP_PROJECT_ROOT",
    .build_dir_env = "TOMBA2RECOMP_BUILD_DIR",
    .force_setup_env = "TOMBA2RECOMP_FORCE_SETUP",
    ...
    .exe_basename = "Tomba__2_Recompiled",
    .prepare_note =
