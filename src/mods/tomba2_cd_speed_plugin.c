 ...
 * timing-sensitive route needs (GH TombaRecomp#5, ported to Tomba 2). The multiplier is a free
 ...
 */
#define PKG "tomba2.enhancement.cd-speed"
...
static void tomba2_cd_speed_activate(void) {
...
PSX_MOD_CONSTRUCTOR(tomba2_register_cd_speed_plugin) {
    (void)psx_mod_register_activation_plugin(
        "tomba2.cd-speed", tomba2_cd_speed_activate);
}
